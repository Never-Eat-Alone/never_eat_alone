...
INSERT INTO restaurants (
  ...
  '+14164794414',
  'EXPENSIVE',
  'https://www.lapinoubistro.com/'
  ),
  ('Jacob''s Steakhouse & Co.',
  '2020-01-02 10:35',
  2,
  'High end steakhouse with beef from Japan, Australia and USA in downtown 
  Toronto.',
  'Grey building with a wide wooden door next to the Citizen bar.',
  '+14163660200',
  'VERY_EXPENSIVE',
  ...
  Vancouver.',
  'Inside the RBC waterfront building at the first floor.',
  '+16473477347',
  'MODERATELY_PRICED',
  ...
  spot in Yorkville.',
  'At the intersection of Cumberland St. and Blair St. with the white 
  exterior.',
  '+14169642222',
  'INEXPENSIVE',
  'https://www.sassafraz.ca/'
  ),
  ('Darbar',
  '2020-03-01 23:14',
  5,
  'Best Persian grill restaurant in Toronto.',
  'Located at the Avenue street with street parkings available to the 
  customers.',
  '+16473514272',
  'EXPENSIVE',
  'https://darbarrestaurant.ca/'
  ),
  ('Grazie',
  '2020-03-01 23:14',
  6,
  'Neighbourhood''s favorite.',
  ...
  '2020-01-14 20:9:2',
  7,
  'A family restaurant focued on the Middle eastern cuisine.',
  'On Yonge street.',
  '+16473484242',
  'MODERATELY_PRICED',
  'https://tabuleyonge.com/'
  ),
  ('Bar Buca',
  '2020-11-08 9:17',
  8,
  'Farm to table concept with traditional italian food.',
  'On the second floor of the four seasons hotel.',
  '+16473591242',
  'MODERATELY_PRICED',
  'http://buca.ca/'
  ),
  ...
  '2020-04-21 10:12:58',
  10,
  'Top brunch place based on BlogTo.',
  '',
  '+16473514245',
  'INEXPENSIVE',
  ...
  'Located at the heart of Yorkville.',
  '+16473514297',
  'VERY_EXPENSIVE',
