...
export class DeactivateAccountSurveyPage extends React.Component<Properties,
    State> {
  constructor(props: Properties) {
    super(props);
    const survey = new AccountDeletedSurvey(this.props.userId, false, false,
    ...
    return (
      <div style={containerStyle} >
        <div style={contentStyle} >
          <h1 style={H1_STYLE} >Acount Deactivated</h1>
          <div style={imageContainerStyle} >
            <img
              style={imageStyle}
              src='resources/illustrations/account_deleted.svg'
              alt='Account Deactivated Image'
            />
          </div>
          <div style={TEXT_STYLE} >
            We’re sad to see you go, but we hope you enjoy your break! When 
            you’re ready to come back, all you need to do is log in to your 
            account.{'\n\n'}
            For now, you can still browse NeverEatAlone as a guest.&nbsp;
