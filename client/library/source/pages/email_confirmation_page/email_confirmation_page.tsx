...
export class EmailConfirmationPage extends React.Component<Properties> {
      ...
      <div style={CONTAINER_STYLE} >
        <div style={{...CONTENT_CONTAINER_STYLE, ...contentStyle}} >
          <div style={TITLE_ROW_STYLE} >
            <img
              style={IMAGE_STYLE}
              src='resources/email_confirmation_page/icons/check.svg'
              alt='Checkmark icon'
            />
            <h1 style={TITLE_STYLE} >Link sent!</h1>
          </div>
          <p style={P_STYLE} >
            You will receive an email soon. Follow the link we sent you to set 
            up your password and profile.
          </p>
        </div>
      </div>);
  }
